...
* 2016-05-16 Results analysis + figures for dissertation         :Lucas:Tais:
...
#+begin_src R :results output graphics :file img/cpp/first_plot_2.png :exports both :width 600 :height 400 :session
library(ggplot2);
...
#+begin_src R :results output graphics :file img/cpp/first_plot_3.pdf :exports both :width 6 :height 4 :session
library(ggplot2);
ggplot(k2[k2$input == "small",], aes(x=version, y=time_avg, color=input)) +
  geom_point() +
